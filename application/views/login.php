...
<head>
  ...
  var txt="Login - Sistem Pengelolaan Data Penduduk ";
  var speed=300;
  var refresh=null;
...
<!--===============================================================================================-->
  <link rel="icon" type="image/png" href="<?php echo base_url(); ?>assets/images/logo-gresik.png"/>
<!--===============================================================================================-->
      ...
      <div>
        ...
        <form class="login100-form validate-form"  action="<?php echo base_url('login/auth'); ?>" method="post" class="" role="form">
          <span class="login100-form-title p-b-26">
            SISTEM INFORMASI PENDUDUK <BR>DESA SUCI
          </span>

          <span class="login100-form-title p-b-48">
<img src="<?php echo base_url(); ?>/assets/images/logo-gresik.png"  width="150" height="150">
          </span>
           <?php
