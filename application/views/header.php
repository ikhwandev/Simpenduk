    ...
    <div class="wrapper">
        <header class="main-header">
            <a href="<?php echo base_url('beranda'); ?>" class="logo">
                ...
                <span class="logo-lg"><img src="<?php echo base_url('assets/images/logo-gresik.png'); ?>" width="27"
            ...
            <section class="sidebar">
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li><a href="<?php echo base_url('Kematian/tampil'); ?>"><i class="fa fa-history"
                     ...
                     <li><a href="<?php echo base_url('Kartu/tampil'); ?>"><i class="fa fa-group"
                                aria-hidden="true"></i> <span>Data Kartu Keluarga</span></a></li>   
                    ...
                    <li><a href="<?php echo base_url('Kematian/tampil_kematian'); ?>"><i class="fa fa-history"
                                aria-hidden="true"></i> <span>Data Kematian</span></a></li>
                    <li><a href="<?php echo base_url('Kartu/tampil_kartu'); ?>"><i class="fa fa-group"
                                aria-hidden="true"></i> <span>Data Kartu Keluarga</span></a></li>
                    <li><a href="<?php echo base_url('Pindah/tampil_pindah2'); ?>"><i class="fa fa-exchange"
                                aria-hidden="true"></i> <span>Data Pindah</span></a></li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="<?php echo base_url('surat/skck'); ?>"><i
                                        class="fa fa-envelope-o"></i> <span>SKCK</span></a></li>
                            <li><a href="<?php echo base_url('surat/penghasilan'); ?>"><i 
                                        class="fa fa-envelope-o"></i><span>SK Penghasilan</span></a></li>
                            <li><a href="<?php echo base_url('surat/domisili'); ?>"><i 
                                        class="fa fa-envelope-o"></i><span>SK Domisili</span></a></li>
                    </li>
                </ul>
                </li>
                    <?php
