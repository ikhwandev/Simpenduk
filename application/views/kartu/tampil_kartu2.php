  ...
  <section class="content">
    <div class="box box-info">
      <div class="box-header">
        ...
        <h4 style="text-align:center"><b>DATA KARTU KELUARGA</b></h4><hr>
      </div>
  ...
  ?>
         <tr>
          ...
          <td style="text-align:center">
            <a href="<?php echo base_url('kartu/detail/' . $kartu->no_kk); ?>" class="btn btn-info btn-xs"><i class="fa fa-info-circle"></i> Detail</a>
          </tr>
        </td>
        <?php
$no++;
