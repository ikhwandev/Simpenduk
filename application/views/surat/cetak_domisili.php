...
<br /><br /><br />
<font align="justify">
    Yang bertandatangan di bawah ini , Kepala Desa Suci Kecamatan Manyar Kabupaten Gresik menerangkan :
</font>
<table width="100%">
    <tr>
...
<font align="justify">
    ...
    berkepentingan menjadi maklum.<br /><br /><br /><br /><br /><br /><br /><br /><br />
</font>
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Suci, <?= date('d F Y', strtotime($domisili->tanggal_domisili)); ?> </center>
        </td>
    </tr>
    <tr>
        <td>
