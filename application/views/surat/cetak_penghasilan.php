...
<font align="justify">
    ...
    Kabupaten Gresik serta, apabila terdapat kekeliruan/kesalahan dalam pembuatannya. Pemohon/pemegang bersedia
    mempertanggung jawabakan secara hukum tanpa melibatkan pihak manapun.<br />

    Demikian surat keterangan ini dibuat dengan sebenarnya serta dapat dipergunakan sebagaimana mestinya.<br /><br /><br /><br /><br />
</font>
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Suci, <?= date('d F Y', strtotime($penghasilan->tanggal_penghasilan)); ?></center>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td></td>
        <td>
            <center>Kecamatan Manyar</center>
        </td>
    </tr>
    <tr>
        <td></td>
